...
use Kelnik\Core\Platform\Attachment\KelnikGenerator;
...
return [
    ...
    */
    ...
    'template' => [
        'header' => 'kelnik-core::platform.brand.header',
        'footer' => 'kelnik-core::platform.brand.footer',
    ],
    ...
    'attachment' => [
        ...
        'generator' => KelnikGenerator::class,
    ],
    ...
    'icons' => [
        ...
        'kelnik' => public_path('vendor/kelnik-core/icons')
    ],
