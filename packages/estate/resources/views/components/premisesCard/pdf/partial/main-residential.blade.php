    ...
    <div class="pdf-section__right">
        ...
        <ul class="pdf-main__list pdf-main__list_theme_dashed">
            ...
            @if($element->area_living)
                <li class="pdf-main__list-item">
                    <div class="pdf-main__list-type">{{ trans('kelnik-estate::front.components.premisesCard.pdf.properties.areaLiving') }}</div>
                    <div class="pdf-main__list-value">{{ trans('kelnik-estate::front.components.premisesCard.pdf.properties.area', ['value' => $element->area_living]) }}</div>
                </li>
            @endif
            @if($element->area_kitchen)
                <li class="pdf-main__list-item">
                    <div class="pdf-main__list-type">{{ trans('kelnik-estate::front.components.premisesCard.pdf.properties.areaKitchen') }}</div>
                    <div class="pdf-main__list-value">{{ trans('kelnik-estate::front.components.premisesCard.pdf.properties.area', ['value' => $element->area_kitchen]) }}</div>
                </li>
            @endif
            @if($hasBuilding)
                <li class="pdf-main__list-item">
        ...
        <div class="pdf-section__right">
            ...
            <div class="pdf-planoplan__app">
                ...
                <ul class="pdf-planoplan__list">
                    <li><img src="/webicons/pdf/store-google.svg" alt="Google Play"></li>
                    <li><img src="/webicons/pdf/store-apple.svg" alt="Appstore"></li>
                </ul>
            </div>
        </div>
    </section>
