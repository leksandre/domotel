...
use Kelnik\EstateVisual\Models\Filters\Contracts\AbstractSliderFilter;
...
final class Price extends AbstractSliderFilter
{
    ...
    {
        return trans('kelnik-estate-search::front.form.price.title');
    }
    ...
    {
        return $val < self::ADJUSTMENT_AT_MILLION
            ? $val * self::ADJUSTMENT_AT_MILLION
            : $val;
    }
}
