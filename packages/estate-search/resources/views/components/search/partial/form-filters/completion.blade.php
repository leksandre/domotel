<div class="parametric-filter__item">
    <div class="custom-select j-parametric-filter__select " data-placeholder="Любой" data-filter="{{ $baseFilter['name'] }}">
        <div class="custom-select__label">{{ $baseFilter['title'] }}</div>
        <div class="custom-select__input j-custom-select__input">
            <span class="custom-select__input-text j-custom-select__value">Любой</span>
