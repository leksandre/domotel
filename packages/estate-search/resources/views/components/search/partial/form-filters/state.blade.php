<div class="parametric-filter__item" hidden>
    @php
        $placeholder = [];
        ...
        $placeholder = count($placeholder) === count($baseFilter['values'])
            ? trans('kelnik-estate-search::front.form.state.all')
            : implode(', ', $placeholder);
    @endphp
    <div class="custom-select j-parametric-filter__select" data-placeholder="{{ $placeholder }}">
