@if(!empty($slider) && $slider->isNotEmpty())
    <div class="grid__visual j-animation__item">
        <div class="gallery-mini">
            <div class="slider slider_theme_utp j-slider-utp">
                <div class="slider__wrap j-slides">
                    @foreach($slider as $slide)
                        <div class="slider-utp" data-caption="{{ $slide['description'] }}">
                            <div class="slider-utp__inner">
                                @if(!$slide['picture'])
                            ...
                            <div class="slider-utp__caption">{{ $slide['description'] }}</div>
                        </div>
                    @endforeach
                </div>
            </div>
